...
export default function ChatScreen() {
  ...
  const sports: Sport[] = [
    {
      id: "NRL",
      name: "NRL",
      icon: "https://imgs.search.brave.com/tU3JEUVqITvAEUmT4Fg2PVxvx-KOAc6mm6twfghxh94/rs:fit:860:0:0:0/g:ce/aHR0cHM6Ly91cGxv/YWQud2lraW1lZGlh/Lm9yZy93aWtpcGVk/aWEvZW4vdGh1bWIv/NS81MC9OYXRpb25h/bF9SdWdieV9MZWFn/dWUuc3ZnLzUxMnB4/LU5hdGlvbmFsX1J1/Z2J5X0xlYWd1ZS5z/dmcucG5n",
    },
    {
      id: "AFL",
      name: "AFL",
      icon: "https://imgs.search.brave.com/cnFDH_O3DRvuN_hjMKv46ANyRpssEU3Ak6uO1aNHGD8/rs:fit:860:0:0:0/g:ce/aHR0cHM6Ly91cGxv/YWQud2lraW1lZGlh/Lm9yZy93aWtpcGVk/aWEvZW4vdGh1bWIv/ZS9lNC9BdXN0cmFs/aWFuX0Zvb3RiYWxs/X0xlYWd1ZS5zdmcv/NTEycHgtQXVzdHJh/bGlhbl9Gb290YmFs/bF9MZWFndWUuc3Zn/LnBuZw",
    },
  ];
  ...
  const playerContextCache = useRef<
    Map<
      string,
      {
        stats: PlayerStats;
  ...
  const initializeVectorStore = async () => {
    try {
      ...
      const nrlContextDocs = [
        ...
        ...markets.map(
          (market) => `${market} odds and statistics for NRL players`
        ),
        ...suggestedQuestions,
      ];
      ...
      const aflContextDocs = [
        ...
        ...aflMarkets.map(
          (market) => `${market} odds and statistics for AFL players`
        ),
        ...aflSuggestedQuestions,
      ];
  ...
  const PLAYER_PATTERNS = {
    ...
    standalone: new RegExp("\\b([A-Z][a-z]+\\s+[A-Z][a-z]+)\\b", "gi"),
  ...
  const extractPlayerInfo = (message: string, sport: string) => {
    ...
    const positionPattern =
      sport === "AFL" ? POSITION_PATTERNS.afl : POSITION_PATTERNS.nrl;
  ...
  const sendMessage = async () => {
    ...
    try {
      ...
      try {
        ...
        const {
          playerNames: playerNamesFromText,
          team: teamFromMessage,
          position: positionFromMessage,
        } = extractPlayerInfo(userMessage, selectedSport);
        ...
        const isGoalScoringQuery = /goal|goals|scorer|scoring/i.test(
          userMessage
        );
        const isDisposalQuery = /disposal|disposals|possession|touches/i.test(
          userMessage
        );
        const isTryScoringQuery = /try|tries|tryscorer|scoring/i.test(
          userMessage
        );
        ...
        if (playerNamesFromText.length > 0) {
          ...
          const playerDataPromises = playerNamesFromText.map(
            async (playerName) => {
              // Check cache first
              const cachedStats = getCachedPlayerData(
                playerName,
                selectedSport
              );
              if (cachedStats) {
              ...
              if (selectedSport === "AFL") {
                ...
                const [aflPlayerData, homeAwayStats, defeatStats] =
                  await Promise.all([
                ...
                if (aflPlayerData) {
                  const playerStats: PlayerStats = {
                    ...
                    goals: {
                      onePlus: {
                        ...
                        percentage:
                          aflPlayerData.Total_Games > 0
                            ? (aflPlayerData.Games_with_1_or_more_goals /
                                aflPlayerData.Total_Games) *
                              100
                            : 0,
                      },
                      twoPlus: {
                        ...
                        percentage:
                          aflPlayerData.Total_Games > 0
                            ? (aflPlayerData.Games_with_2_or_more_goals /
                                aflPlayerData.Total_Games) *
                              100
                            : 0,
                      },
                      threePlus: {
                        ...
                        percentage:
                          aflPlayerData.Total_Games > 0
                            ? (aflPlayerData.Games_with_3_or_more_goals /
                                aflPlayerData.Total_Games) *
                              100
                            : 0,
                      },
                    ...
                    disposals: {
                      fifteenPlus: {
                        ...
                        percentage:
                          aflPlayerData.Total_Games > 0
                            ? (aflPlayerData.Games_with_15_or_more_disposals /
                                aflPlayerData.Total_Games) *
                              100
                            : 0,
                      },
                      twentyPlus: {
                        ...
                        percentage:
                          aflPlayerData.Total_Games > 0
                            ? (aflPlayerData.Games_with_20_or_more_disposals /
                                aflPlayerData.Total_Games) *
                              100
                            : 0,
                      },
                      thirtyPlus: {
                        ...
                        percentage:
                          aflPlayerData.Total_Games > 0
                            ? (aflPlayerData.Games_with_30_or_more_disposals /
                                aflPlayerData.Total_Games) *
                              100
                            : 0,
                      },
                  ...
                  try {
                    ...
                    const directPlayerData = (aflPlayerSummary as any[]).find(
                      (p) =>
                        p.Player?.toLowerCase() === playerName.toLowerCase() ||
                        p.Player?.toLowerCase().includes(
                          playerName.toLowerCase()
                        ) ||
                        playerName
                          .toLowerCase()
                          .includes(p.Player?.toLowerCase())
                    );
                    ...
                    if (directPlayerData) {
                      const playerStats: PlayerStats = {
                        ...
                        goals: {
                          onePlus: {
                            count:
                              directPlayerData.Games_with_1_or_more_goals || 0,
                            odds: directPlayerData.Odds_1_or_more_goals || 0,
                            percentage:
                              directPlayerData.Total_Games > 0
                                ? (directPlayerData.Games_with_1_or_more_goals /
                                    directPlayerData.Total_Games) *
                                  100
                                : 0,
                          },
                          twoPlus: {
                            count:
                              directPlayerData.Games_with_2_or_more_goals || 0,
                            odds: directPlayerData.Odds_2_or_more_goals || 0,
                            percentage:
                              directPlayerData.Total_Games > 0
                                ? (directPlayerData.Games_with_2_or_more_goals /
                                    directPlayerData.Total_Games) *
                                  100
                                : 0,
                          },
                          threePlus: {
                            count:
                              directPlayerData.Games_with_3_or_more_goals || 0,
                            odds: directPlayerData.Odds_3_or_more_goals || 0,
                            percentage:
                              directPlayerData.Total_Games > 0
                                ? (directPlayerData.Games_with_3_or_more_goals /
                                    directPlayerData.Total_Games) *
                                  100
                                : 0,
                          },
                        ...
                        disposals: {
                          fifteenPlus: {
                            count:
                              directPlayerData.Games_with_15_or_more_disposals ||
                              0,
                            odds:
                              directPlayerData.Odds_15_or_more_disposals || 0,
                            percentage:
                              directPlayerData.Total_Games > 0
                                ? (directPlayerData.Games_with_15_or_more_disposals /
                                    directPlayerData.Total_Games) *
                          ...
                          twentyPlus: {
                            count:
                              directPlayerData.Games_with_20_or_more_disposals ||
                              0,
                            odds:
                              directPlayerData.Odds_20_or_more_disposals || 0,
                            percentage:
                              directPlayerData.Total_Games > 0
                                ? (directPlayerData.Games_with_20_or_more_disposals /
                                    directPlayerData.Total_Games) *
                          ...
                          thirtyPlus: {
                            count:
                              directPlayerData.Games_with_30_or_more_disposals ||
                              0,
                            odds:
                              directPlayerData.Odds_30_or_more_disposals || 0,
                            percentage:
                              directPlayerData.Total_Games > 0
                                ? (directPlayerData.Games_with_30_or_more_disposals /
                                    directPlayerData.Total_Games) *
                        ...
                        recentForm: {
                          ...
                          goalsLast10:
                            directPlayerData.Goals_Last_10_Games || 0,
                          disposalsLast5:
                            directPlayerData.Disposals_Last_5_Games || 0,
                          disposalsLast10:
                            directPlayerData.Disposals_Last_10_Games || 0,
                        },
                      };

                      // Find player home/away stats
                      const homeAwayData = (aflHomeAway as any[]).find(
                        (p) =>
                      ...
                      if (homeAwayData) {
                        playerStats.homeAway = {
                          ...
                          home_games_with_goals:
                            homeAwayData.home_games_with_goals || 0,
                          away_games_with_goals:
                            homeAwayData.away_games_with_goals || 0,
                          home_goal_percentage:
                            homeAwayData.home_goal_percentage || 0,
                          away_goal_percentage:
                            homeAwayData.away_goal_percentage || 0,
                        };
                      }

                      // Find player defeat stats
                      const defeatData = (aflDefeats as any[]).find(
                        (p) =>
                          p.full_name?.toLowerCase() ===
                            playerName.toLowerCase() ||
                          p.full_name
                      ...
                      if (defeatData) {
                        playerStats.defeat = {
                          ...
                          loss_games_with_goals:
                            defeatData.loss_games_with_goals || 0,
                          loss_goal_percentage:
                            defeatData.loss_goal_percentage || 0,
                        };
                      }
                    ...
                    logger.error(
                      `Error getting AFL player data directly for ${playerName}:`,
                      directDataError
                    );
                  }
                }
                ...
                const playerData = await dataProcessor.getPlayerStats(
                  playerName
                );
                if (playerData) {
          ...
          for (const [playerName, stats] of Object.entries(
            ...
            if (selectedSport === "AFL") {
              ...
              if (isGoalScoringQuery || !isDisposalQuery) {
                playerContext += `\nGoal Scoring:\n`;
                playerContext += `Games_with_1_or_more_goals: ${
                  stats.goals?.onePlus.count || 0
                }\n`;
                playerContext += `Odds_1_or_more_goals: ${
                  stats.goals?.onePlus.odds || 0
                }\n`;
                playerContext += `Games_with_2_or_more_goals: ${
                  stats.goals?.twoPlus.count || 0
                }\n`;
                playerContext += `Odds_2_or_more_goals: ${
                  stats.goals?.twoPlus.odds || 0
                }\n`;
                playerContext += `Games_with_3_or_more_goals: ${
                  stats.goals?.threePlus.count || 0
                }\n`;
                playerContext += `Odds_3_or_more_goals: ${
                  stats.goals?.threePlus.odds || 0
                }\n`;
                playerContext += `Goals_Last_5_Games: ${
                  stats.recentForm?.goalsLast5 || 0
                }\n`;
                playerContext += `Goals_Last_10_Games: ${
                  stats.recentForm?.goalsLast10 || 0
                }\n`;
              }
              ...
              if (isDisposalQuery || !isGoalScoringQuery) {
                playerContext += `\nDisposals:\n`;
                playerContext += `Games_with_15_or_more_disposals: ${
                  stats.disposals?.fifteenPlus.count || 0
                }\n`;
                playerContext += `Odds_15_or_more_disposals: ${
                  stats.disposals?.fifteenPlus.odds || 0
                }\n`;
                playerContext += `Games_with_20_or_more_disposals: ${
                  stats.disposals?.twentyPlus.count || 0
                }\n`;
                playerContext += `Odds_20_or_more_disposals: ${
                  stats.disposals?.twentyPlus.odds || 0
                }\n`;
                playerContext += `Games_with_30_or_more_disposals: ${
                  stats.disposals?.thirtyPlus.count || 0
                }\n`;
                playerContext += `Odds_30_or_more_disposals: ${
                  stats.disposals?.thirtyPlus.odds || 0
                }\n`;
                playerContext += `Disposals_Last_5_Games: ${
                  stats.recentForm?.disposalsLast5 || 0
                }\n`;
                playerContext += `Disposals_Last_10_Games: ${
                  stats.recentForm?.disposalsLast10 || 0
                }\n`;
              }
              ...
              // NRL player context
              playerContext += `Player name: ${stats.name}\nNRL player summary:\n`;
              playerContext += `ACTUAL_GAMES_PLAYED: ${
                stats.gamesPlayed || 0
              }\n`;
              ...
              playerContext += `TotalFts2HPlayer: ${
                stats.secondHalfFirstTries || 0
              }\n`;
              playerContext += `TotalTwoPlusTryPlayer: ${
                stats.twoPlusTries || 0
              }\n`;
              playerContext += `Team: ${stats.team || ""}\n`;
              playerContext += `ATS_Last_5_Games: ${
                stats.atsLast5Games || 0
              }\n`;
              playerContext += `ATS_Last_10_Games: ${
                stats.atsLast10Games || 0
              }\n`;

              // Format position-specific data if available
              if (stats.positions && Object.keys(stats.positions).length > 0) {
                playerContext += "\nPositional Stats:\n";
                for (const [position, posStats] of Object.entries(
                  stats.positions
                )) {
                  playerContext += `Position: ${position}\n`;
                  playerContext += `POSITION_ACTUAL_GAMES: ${
                    posStats.gamesPlayed || 0
                  }\n`;
                  playerContext += `Total ATS in Position: ${
                    posStats.tries || 0
                  }\n`;
                  playerContext += `Total FTS in Position: ${
                    posStats.firstTries || 0
                  }\n`;
                  playerContext += `Total LTS in Position: ${
                    posStats.lastTries || 0
                  }\n`;
                  playerContext += `Total FTS2H in Position: ${
                    posStats.secondHalfFirstTries || 0
                  }\n`;
                  playerContext += `Total 2+ Tries in Position: ${
                    posStats.twoPlusTries || 0
                  }\n`;
                }
              }
            }
