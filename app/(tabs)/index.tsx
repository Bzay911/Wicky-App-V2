      ...
      <View style={styles.tweetCard}>
        <View style={styles.tweetHeader}>
          <Image
            ...
            style={[styles.avatar, isAflTweet && styles.aflAvatar]}
          ...
          <Text style={styles.tweetTime}>
            {formatTweetDate(item.created_at)}
          </Text>
        </View>
        ...
        {item.media && item.media.length > 0 && (
          <View style={styles.mediaContainer}>
            {item.media.map((media, mediaIndex) => {
              ...
              const uniqueMediaKey = `${item.id}-${mediaIndex}-${
                media.media_key || ""
              }`;
          ...
          >
            ...
            >
              ...
              <Text
                style={[
                  styles.tabText,
                  selectedSport === "all" && styles.activeTabText,
                ]}
              >
                All
              </Text>
          ...
          >
            ...
            >
              ...
              <Text
                style={[
                  styles.tabText,
                  selectedSport === "nrl" && styles.activeTabText,
                ]}
              >
                NRL
              </Text>
          ...
          >
            ...
            >
              ...
              <Text
                style={[
                  styles.tabText,
                  selectedSport === "afl" && styles.activeTabText,
                ]}
              >
                AFL
              </Text>
          ...
          >
            ...
            >
              ...
              <Text
                style={[
                  styles.tabText,
                  selectedSport === "nba" && styles.activeTabText,
                ]}
              >
                NBA
              </Text>
      ...
      <View style={styles.container}>
        ...
        {loading ? (
          ...
          <View style={styles.errorContainer}>
            <Feather name="wifi-off" size={48} color="#8BCEA9" />
              ...
              onPress={() => {
                const tweetData =
                  selectedSport === "all"
                    ? ALL_TWEETS
                    : ALL_TWEETS.filter(
                        (tweet) => tweet.sport === selectedSport
                      );
                setTweets(tweetData);
                setLoading(false);
              }}
